...
describe('RegisterScreen', () => {
  ...
  describe('Username Validation', () => {
    it('should show error for invalid username (too short)', async () => {
      ...
      expect(getByText('Username must be between 3 and 20 alphanumeric characters.')).toBeTruthy();
    });
  ...
  describe('Password Validation', () => {
    it('should show error for password without uppercase letter', async () => {
      ...
      expect(getByText('Password must be between 8 and 20 characters and contain one uppercase letter, one lowercase letter, and one number.')).toBeTruthy();
    });
